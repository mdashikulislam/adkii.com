...
<div data-preview="#{{ $field['name'] }}"
    ...
    @include('admin.fields.inc.field_wrapper_attributes')
>
    <div class="col-12 text-center p-2 border border-1 border-light rounded-2" style="height: 100%;">
        ...
        <div class="row d-flex justify-content-center mt-3 mb-3">
            <div class="col-sm-6 text-center">
                @php
                    ...
                    $defaultPicture = 'default/image/picture.jpg';
                    $defaultPictureUrl = asset($defaultPicture);
        ...
        <div class="btn-group">
            <label class="btn btn-primary btn-file mb-0">
                ...
                <input type="file"
                       accept="image/*"
                       id="uploadImage" @include('admin.fields.inc.field_attributes', ['default_class' => 'hide'])
                >
...
@if (checkIfFieldIsFirstOfItsType($field, $fields))
    @push('style')
        <link href="{{ asset('admin/assets/vendors/cropper/dist/cropper.min.css') }}" rel="stylesheet" type="text/css" />
    @endpush
    ...
    @endpush
    @push('script-library')
        <script src="{{ asset('admin/assets/vendors/cropper/dist/cropper.min.js') }}"></script>
    @endpush
